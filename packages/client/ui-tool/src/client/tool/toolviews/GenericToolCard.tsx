...
export function GenericToolCard({ toolName, block, cwd, openFile, openDocument, inspect, t }: GenericToolCardProps) {
  ...
  return (
    <ToolRow
      ...
      onOpenDocument={singleFile ? openDocument : undefined}
      inspect={inspect}
    />
  )
}
