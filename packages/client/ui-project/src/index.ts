/**
 * Project plugin, node half. The roster row exists so the browser half (the
 * sidebar project directory tree) loads; there are no host-side
 * registrations and the plugin contributes nothing to the model's context.
