...
export type {
  ...
  ConvViewProps, DetailsDocumentOwnerProps, DetailsInjected, DetailsSlotProps, DetailsToolOwnerProps,
  DocumentOpen, DocumentOpenRequest, EmptyWorkspaceOwnerProps,
