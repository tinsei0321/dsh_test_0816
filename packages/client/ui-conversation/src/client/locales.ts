...
export const zh = {
  ...
  'chat.toBottom': '回到底部',
  'chat.step': '步骤 {n}',
  'chat.step.status.running': '进行中',
  'chat.step.status.completed': '已完成',
  'chat.step.status.error': '出错',
...
export const en = {
  ...
  'details.tab.document': 'Documents',
  ...
  'chat.step': 'Step {n}',
  'chat.step.status.running': 'Running',
  'chat.step.status.completed': 'Completed',
  'chat.step.status.error': 'Error',
  ...
  'approval.answered': 'Decision submitted',
