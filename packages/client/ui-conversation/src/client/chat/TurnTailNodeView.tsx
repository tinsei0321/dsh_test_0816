...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  node, openFile, openDocument, forkAt, renderSlot, renderSlotChain, t, useSession,
  ...
  const owner: TurnTailOwnerProps = { turn, seq: closing?.finalNode.seq ?? data.seq, openFile, openDocument }
