- banner:
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Step 1 Running Use the ask_user_question tool to ask me exactly one question with id "checkpoint", question "Ready to continue?", header "Checkpoint", and options labeled "Yes" and "No". After I answer, reply with one short sentence acknowledging my answer and stop. {{clock}}
- button "Copy":
  - img
