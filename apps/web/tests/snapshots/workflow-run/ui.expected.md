...
- button "Tool call workflow · {{duration}}":
  - img
  - img
  - text: Tool call workflow · {{duration}}
...
- text: Reply with exactly the word WF_CHILD_OK and not… Completed Step 2 Completed
