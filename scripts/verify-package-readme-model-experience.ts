...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-document': { kind: 'none', reason: 'Browser-side read-only projection of logged read/edit/search tool results; registers nothing model-facing.' },
  'packages/client/ui-project': { kind: 'none', reason: 'Browser-side workspace directory tree over host.listTreeEntries; registers nothing model-facing.' },
  ...
  'packages/client/ui-usage-monitor': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/host/usage-monitor': { kind: 'none', reason: 'Host-side Remote gateway aggregating usage and balance; registers nothing model-facing.' },
